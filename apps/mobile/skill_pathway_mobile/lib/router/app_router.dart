...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/course-detail', builder: (context, state) => CourseDetailScreen(
      course: state.extra as CourseDetail,
    )),
    GoRoute(path: '/course-listing', builder: (context, state) => const CourseListingScreen()),
    GoRoute(path: '/degree-comparison', builder: (context, state) => DegreeComparisonScreen(
      confirmedField: state.extra as String? ?? 'Computer Science',
    )),
    GoRoute(path: '/field-selection', builder: (context, state) => FieldSelectionScreen(
    ...
    GoRoute(path: '/job-sector-detail', builder: (context, state) => JobSectorDetailScreen(
    ...
    GoRoute(path: '/resume-interview-prep', builder: (context, state) => ResumeInterviewPrepScreen()),
    GoRoute(path: '/scholarship-info', builder: (context, state) => const ScholarshipInfoScreen()),
    GoRoute(path: '/university-detail', builder: (context, state) => UniversityDetailScreen(
